...
public class Commands implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(args.length < 1 || args[0].equalsIgnoreCase("help")) {
			...
			if(nbti.hasKey("Plugin") && nbti.getString("Plugin").equals("BetterTools")) {
				if(args.length > 1) {
					if(args[1].equalsIgnoreCase("#empty") || args[1].equalsIgnoreCase("none") || args[1].equalsIgnoreCase("#off") || args[1].equalsIgnoreCase("#clear")) {
						...
						String invalidName = StringUtils.checkStringList(args[1], "mask");
						if(invalidName == null) {
			...
			if(nbti.hasKey("Plugin") && nbti.getString("Plugin").equals("BetterTools")) {
				if(args.length > 1) {
					String invalidName = StringUtils.checkStringList(args[1], "blocks");
					if(invalidName == null) {
			...
			if(nbti.hasKey("Plugin") && nbti.getString("Plugin").equals("BetterTools")) {
				if(args.length > 1) {
					String invalidName = StringUtils.checkStringList(args[1], "through");
					if(invalidName == null) {
			...
			if(nbti.hasKey("Plugin") && nbti.getString("Plugin").equals("BetterTools")) {
				if(args.length > 1) {
					String invalidName = StringUtils.checkStringList(args[1], "touching");
					if(invalidName == null) {
						...
						item.setItemMeta(meta);
						p.getInventory().setItemInMainHand(item);
					}else if(invalidName.equalsIgnoreCase("any") || invalidName.equalsIgnoreCase("#empty") || invalidName.equalsIgnoreCase("#off") || invalidName.equalsIgnoreCase("#clear")){
						nbti.setString("Touching", "");
						ItemStack item = nbti.getItem();
						ItemMeta meta = item.getItemMeta();
						if(nbti.getString("Item").equals("Paint Tool"))
			...
			NBTItem nbti = new NBTItem(p.getInventory().getItemInMainHand());
			if(nbti.hasKey("Plugin") && nbti.getString("Plugin").equals("BetterTools")) {
				if(args.length == 2 && (args[1].equals("#off") || args[1].equalsIgnoreCase("#clear"))) {
